resource "aws_instance" "my-ec2-instance" {
  ...
  # use the 'element' function to iterate through the var.azs list to retrieve a different az value each time
  # will wrap around if 'count' exceeds the number of list items - utilized to spread vms across az's for redundency
